...
Cross-head WHT ($8{\times}8$) & $+7186$\,\% (catastrophic) & Never use \\
\bottomrule
\end{tabular}
\end{table}
...
so the simpler shared-matrix approach is preferred; (4) cross-head WHT (applying
an $8{\times}8$ Hadamard across heads rather than within a single head) is
catastrophic---PPL increases by $+7186$\,\%---and must never be used.
